...
RANK_PATH = Path("/workspace/reports/rank_20260922.json")
QUAL_PATH = Path("/workspace/reports/qual_20260922.json")

HTML_OUT = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-09-22.html")
PDF_WORKSPACE = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-09-22.pdf")
PDF_ARTIFACT = Path("/opt/cursor/artifacts/NASDAQ_Deep_Analysis_2026-09-22.pdf")
PDF_ASSETS = Path("/workspace/assets/NASDAQ_Deep_Analysis_2026-09-22.pdf")
CHASE_OUT = Path("/workspace/reports/chase_rr_20260922.json")
...
# Portfolio-aware Chase label overrides — 2026-09-22
LABEL_OVERRIDE = {
    "ALKS": "중상·SOFT·워치",
...
CHASE_DETAIL = {
    ...
    "TXG": "중하·보유4주·천장근접·추가금지 — 19.7%≈천장20%·stop $42. NO_ADD·추격 금지.",
...
def load_buy_scenarios() -> list[dict]:
    p = Path("/workspace/reports/buy_scenarios_20260922.json")
    if not p.exists():
        return []
...
def main() -> None:
    ...
    <section class="cover">
      ...
      <div class="portfolio-box" style="text-align:left;max-width:560px;margin:16px auto;">
        <b>포트 실행 메모 (9/22 스냅 · 최신 SSOT · 비중정책 개정)</b><br/>
        <b>종목천장 20%</b>(품질등급 A/B/C 폐기) · 금지=ADD0 · Top3≤50% · 현금바닥 $150<br/>
        보유: TXG4 · ECPG3 · APPS20 · ANAB4 · DRH14 · ROKU1 · APA3 · ATRO1 · 평가~$1,608 · 현금합≈$232<br/>
        APA +2(1→3) · ATRO −1(2→1) · Top3≈53.6%<b>&gt;50%</b> · 8종 전원 NO_ADD · 전개가능≈$82<br/>
        비중: TXG 19.7%<b>천장근접</b> · 나머지&lt;20%(ECPG18.5·APPS15.3·ANAB13.7·DRH10.7·ROKU9.6·APA8.2·ATRO4.3)<br/>
    ...
    <section class="ticker-section">
      ...
      <p class="small">다음 단계: 기술적분석() ← chase_rr_20260922.json</p>
    </section>
    </body></html>
    """
    ...
    try:
        ...
        notes = (
            ...
            f"- 비중정책: 종목천장 20%(A/B/C 폐기) · Top3≤50% · TXG≈19.7% 천장근접 · Top3≈53.6%>50%\n"
        )
