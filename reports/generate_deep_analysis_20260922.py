...
CHASE_DETAIL = {
    ...
    "APA": "중·품질C·보유3주(+2)·한도OVER·추가금지 — 8.2%>C6%·stop $40. NO_ADD·추격 금지.",
    ...
    "ATRO": "중·품질C·보유1주(−1)·추가금지 — 4.3%·마크≈stop $68. 축소완료·NO_ADD.",
    "AVT": "중 — IT 유통. 중간·눌림.",
    "ALNT": "중 — 모션컨트롤. 산업 베타.",
