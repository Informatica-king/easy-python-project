#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fetch Chase rank + qual stubs for 2026-09-23 deep universe (48 tickers)."""
...
ASOF = date(2026, 9, 23)
TICKERS = [
    "MU", "CDNA", "QMCO", "ETON", "INTC", "CLMT", "APPS", "COHU", "TH", "CRSR",
    "NBIS", "FEIM", "FTNT", "ZBRA", "RDVT", "SBLK", "SLDE", "ROKU", "TER", "IOVA",
    "NESR", "INCY", "SNDK", "XNCR", "HTFL", "STX", "PLPC", "SIMO", "DXCM", "NTNX",
    "CORT", "MRVL", "QRVO", "NEOG", "AVT", "ENTG", "ALNT", "FROG", "NSIT", "NTRA",
    "CNXN", "AMRX", "DGII", "CAKE", "DDOG", "CHEF", "BAND", "SCSC",
]

OUT = Path("/workspace/reports/rank_20260923.json")
QUAL_SEEDS = [
...
QUAL_OUT = Path("/workspace/reports/qual_20260923.json")
FORMULA = (
