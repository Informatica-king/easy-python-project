#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""NASDAQ 심층분석 PDF — 2026-09-23 (48종목 · 매수시나리오 A′ 점검) + Chase 스냅샷 + 기술적분석 훅."""
...
RANK_PATH = Path("/workspace/reports/rank_20260923.json")
QUAL_PATH = Path("/workspace/reports/qual_20260923.json")

HTML_OUT = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-09-23.html")
PDF_WORKSPACE = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-09-23.pdf")
PDF_ARTIFACT = Path("/opt/cursor/artifacts/NASDAQ_Deep_Analysis_2026-09-23.pdf")
PDF_ASSETS = Path("/workspace/assets/NASDAQ_Deep_Analysis_2026-09-23.pdf")
CHASE_OUT = Path("/workspace/reports/chase_rr_20260923.json")
...
def load_buy_scenarios() -> list[dict]:
    p = Path("/workspace/reports/buy_scenarios_20260923.json")
    if not p.exists():
        return []
...
def main() -> None:
    ...
    HOLD_NO_ADD = {"TXG", "ECPG", "APPS", "ANAB", "DRH", "ROKU", "ATRO", "APA"}
    for h in exec_hits:
    ...
    <section class="cover">
      ...
      <div class="portfolio-box" style="text-align:left;max-width:560px;margin:16px auto;">
        <b>포트 실행 메모 (9/23 스냅 · 최신 SSOT · 유동천장)</b><br/>
        <b>종목천장 20%</b>(유동=주식+현금 · A/B/C 폐기) · 금지=ADD0 · Top3≤50%(유동) · 현금바닥 $150<br/>
        보유: TXG4 · ECPG3 · APPS20 · ANAB3 · DRH14 · ROKU1 · APA3 · ATRO1 · 평가~$1,540 · 현금합≈$286<br/>
        ANAB −1(4→3) · Top3≈46.8%(유동)≤50% · 8종 전원 NO_ADD · 전개가능≈$136<br/>
        유동비중: TXG 17.3% · ECPG 16.2% · APPS 13.4% · DRH 9.5% · ANAB 8.8% · ROKU 8.4% · APA 7.1% · ATRO 3.8% · 전원&lt;20%<br/>
        유니버스∩보유: APPS·ROKU (TXG·ECPG·ANAB·DRH·APA·ATRO는 유니버스 외·NO_ADD 유지)<br/>
        AMRX/FTNT/SCSC/CMPR/NESR 청산후 추격금지 · ATRO stop $68 근처 · 실행창 17:30~20:55 지정가<br/>
        유니버스 48종 · +ENTG·CAKE·BAND · −FSLY·VCTR·ECPG · 본선∩GO 강조 · PDF=GitHub Release만
      </div>
    </section>
    {buy_scenario_section(scenarios, exec_hits=exec_live)}
    <h2>Surprise / Chase 요약</h2>
    <p class="small">정렬: Chase RR. 가격·PT는 {DATE_TAG} 라이브. 48종 · 유니버스: MU·CDNA·QMCO·ETON·INTC·CLMT·APPS·ENTG·CAKE·BAND 등 · APA3·ATRO1·ANAB3 NO_ADD.<br/>
    ...
    <section class="ticker-section">
      ...
      <p class="small">다음 단계: 기술적분석() ← chase_rr_20260923.json</p>
    </section>
    </body></html>
    """
    ...
    try:
        ...
        notes = (
            ...
            f"- 보유 NO_ADD: TXG·ECPG·APPS·ANAB·DRH·ROKU·ATRO·APA\n"
            f"- 비중정책: 종목천장 20%(유동=주식+현금 · A/B/C 폐기) · Top3≤50% · TXG≈17.3%(유동) 천장여유 · Top3≈46.8%(유동)≤50%\n"
        )
