#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fetch Chase rank + qual stubs for 2026-09-25 deep universe (45 tickers)."""
...
ASOF = date(2026, 9, 25)
TICKERS = [
    "MU", "QMCO", "CDNA", "ETON", "INTC", "CLMT", "FSLY", "COHU", "TH", "CRSR",
    "FTNT", "FEIM", "NBIS", "RDVT", "ZBRA", "SBLK", "ROKU", "SLDE", "TER", "IOVA",
    "NESR", "INCY", "XNCR", "HTFL", "STX", "PLPC", "ECPG", "DIOD", "SIMO", "DXCM",
    "SANM", "NTNX", "CORT", "MRVL", "QRVO", "NEOG", "AVT", "ENTG", "ALNT", "FROG",
    "NSIT", "NTRA", "CNXN", "AMRX", "DGII",
]

OUT = Path("/workspace/reports/rank_20260925.json")
QUAL_SEEDS = [
    Path("/workspace/reports/qual_20260924.json"),
    Path("/workspace/reports/qual_20260923.json"),
    Path("/workspace/reports/qual_20260922.json"),
    Path("/workspace/reports/qual_20260908.json"),
    Path("/workspace/reports/qual_20260828.json"),
    Path("/workspace/reports/qual_20260825.json"),
    Path("/workspace/reports/qual_20260820.json"),
    Path("/workspace/reports/qual_20260819.json"),
    Path("/workspace/reports/qual_20260818.json"),
    Path("/workspace/reports/qual_20260814.json"),
    Path("/workspace/reports/qual_20260812.json"),
    Path("/workspace/reports/qual_20260807.json"),
    Path("/workspace/reports/qual_20260806.json"),
    Path("/workspace/reports/qual_20260805.json"),
    Path("/workspace/reports/qual_20260804.json"),
]
QUAL_OUT = Path("/workspace/reports/qual_20260925.json")
FORMULA = (
