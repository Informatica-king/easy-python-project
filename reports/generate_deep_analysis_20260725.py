#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""NASDAQ 심층분석 PDF — 2026-07-25 (39종목) + Chase 스냅샷 + 기술적분석 훅."""
...
RANK_PATH = Path("/tmp/rank_20260725.json")
QUAL_PATH = Path("/tmp/qual_20260725.json")

HTML_OUT = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-07-25.html")
PDF_WORKSPACE = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-07-25.pdf")
PDF_ARTIFACT = Path("/opt/cursor/artifacts/NASDAQ_Deep_Analysis_2026-07-25.pdf")
PDF_ASSETS = Path("/workspace/assets/NASDAQ_Deep_Analysis_2026-07-25.pdf")
CHASE_OUT = Path("/workspace/reports/chase_rr_20260725.json")
...
# Portfolio-aware Chase label overrides — 2026-07-25
LABEL_OVERRIDE = {
    "SLS": "상·위성·바이너리",
    "LASR": "상·08-06",
    "ECPG": "최상·코어보유·추가금지",
...
def main() -> None:
    ...
    <section class="cover">
      <h1>NASDAQ 심층분석</h1>
      <p class="sub">Chase Risk-Reward · 실적 서프라이즈 · 39종목</p>
      ...
      <div class="portfolio-box" style="text-align:left;max-width:520px;margin:24px auto;">
        <b>포트 실행 메모 (7/25)</b><br/>
        보유: NEO · ECPG · AMRX · MU · NESR · INDV · CRDO(소액)<br/>
        청산: ASTH 전량<br/>
        이벤트: NEO/ALKS/ACHC/KNSA 07-28 · AMRX/VCYT 07-30<br/>
        NESR: $25–27 밴드만 · ECPG stop $80 · NEO stop $12 / tp1 $16<br/>
        과열·바이너리 추격 금지 · NEO 실적 전 NO_ADD
      </div>
    </section>
