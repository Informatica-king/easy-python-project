#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""NASDAQ 심층분석 PDF — 2026-07-27 (50종목) + Chase 스냅샷 + 기술적분석 훅."""
...
RANK_PATH = Path("/tmp/rank_20260727.json")
QUAL_PATH = Path("/tmp/qual_20260727_full.json")

HTML_OUT = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-07-27.html")
PDF_WORKSPACE = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-07-27.pdf")
PDF_ARTIFACT = Path("/opt/cursor/artifacts/NASDAQ_Deep_Analysis_2026-07-27.pdf")
PDF_ASSETS = Path("/workspace/assets/NASDAQ_Deep_Analysis_2026-07-27.pdf")
CHASE_OUT = Path("/workspace/reports/chase_rr_20260727.json")
...
# Portfolio-aware Chase label overrides — 2026-07-27
LABEL_OVERRIDE = {
    "LASR": "상·코어이관후보·08-06",
    "NEO": "최상·07-28이벤트·보유",
    "ECPG": "최상·코어·강등후보",
...
def main() -> None:
    ...
    <section class="cover">
      ...
      <div class="portfolio-box" style="text-align:left;max-width:520px;margin:24px auto;">
        <b>포트 실행 메모 (7/27)</b><br/>
        보유: NEO · ECPG · AMRX · MU(예외작전) · CRDO · NESR · SCHD<br/>
        비중OS: 코어~20% · 위성≤10% · SCHD→10% · 현금바닥 $150<br/>
        이벤트: NEO 07-28 · AMRX/VCYT 07-30 · LASR/ROKU/RAPP 08-06<br/>
        LASR: 코어 이관 후보 · MU 익절/무손실 청산 전 코어(20%) 금지<br/>
        과열·바이너리 추격 금지 · 실적 D-5 즉흥 금지
    </section>
