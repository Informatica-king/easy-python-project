#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""NASDAQ 심층분석 PDF — 2026-07-30 (50종목) + Chase 스냅샷 + 기술적분석 훅."""
...
RANK_PATH = Path("/tmp/rank_20260730.json")
QUAL_PATH = Path("/tmp/qual_20260730_full.json")

HTML_OUT = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-07-30.html")
PDF_WORKSPACE = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-07-30.pdf")
PDF_ARTIFACT = Path("/opt/cursor/artifacts/NASDAQ_Deep_Analysis_2026-07-30.pdf")
PDF_ASSETS = Path("/workspace/assets/NASDAQ_Deep_Analysis_2026-07-30.pdf")
CHASE_OUT = Path("/workspace/reports/chase_rr_20260730.json")
...
def main() -> None:
    ...
    <section class="cover">
      <h1>NASDAQ 심층분석</h1>
      <p class="sub">Chase Risk-Reward · 실적 서프라이즈 · 50종목</p>
      ...
      <div class="portfolio-box" style="text-align:left;max-width:540px;margin:24px auto;">
        <b>포트 실행 메모 (7/30 · MU/CRDO 매도 후 현금대기 가정)</b><br/>
        보유 기준: ECPG · AMRX · LASR · SCHD · NESR · (MU/CRDO 전량매도 대기→체결확인)<br/>
        현금 높게 유지 · 신규매수보다 리스크축소 · LASR 무효~$60.50<br/>
        오늘 실적: AMRX·VCYT·LAUR·CDNA·DRH — EARN_D5·즉흥금지<br/>
        직후 워치: ADPT/CHEF/BIIB/CMPR(07-29) · RELY/ECPG/HST/APA 08-05 · ROKU/RAPP 08-06<br/>
        정리 후보: ECPG 2→1 · NESR 축소 · 과열·반도체 추격 금지
      </div>
    </section>
