#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""NASDAQ 심층분석 PDF — 2026-09-16 (45종목 · 매수시나리오 A′ 점검) + Chase 스냅샷 + 기술적분석 훅."""
...
RANK_PATH = Path("/workspace/reports/rank_20260916.json")
QUAL_PATH = Path("/workspace/reports/qual_20260916.json")

HTML_OUT = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-09-16.html")
PDF_WORKSPACE = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-09-16.pdf")
PDF_ARTIFACT = Path("/opt/cursor/artifacts/NASDAQ_Deep_Analysis_2026-09-16.pdf")
PDF_ASSETS = Path("/workspace/assets/NASDAQ_Deep_Analysis_2026-09-16.pdf")
CHASE_OUT = Path("/workspace/reports/chase_rr_20260916.json")
...
# Portfolio-aware Chase label overrides — 2026-09-16
LABEL_OVERRIDE = {
    "ALKS": "중상·SOFT·워치",
    "ECPG": "중·품질A·보유3주·한도OVER·추가금지",
    "ROKU": "중·품질C·보유1주·한도OVER·추가금지",
    "HST": "중상·08-05·고점",
    "INDV": "중·청산후워치·08-04",
    "TXG": "중하·품질C·보유4주·한도OVER·추가금지",
    "APA": "중·품질C·보유1주·추가금지",
    "ADPT": "중·SOFT·실적직후",
    "SBLK": "중상·고점주의",
    "CASY": "중·SOFT·고점주의",
    ...
    "OMER": "중하·임상변동",
    "CRDO": "중·청산후워치·추격금지",
    "ATRO": "중·품질C·보유2주·stop하회·축소검토·추가금지",
    "AVT": "중",
    "ALNT": "중",
    "RDVT": "중",
    "XNCR": "중하·임상변동",
...
CHASE_DETAIL = {
    ...
    "ECPG": "중·품질A·보유3주(+1)·한도OVER·추가금지 — 19.0%>A18%·stop $80. NO_ADD·추격 금지.",
    "ROKU": "중·품질C·보유1주·한도OVER·추가금지 — 10.1%>C6%·stop $140. NO_ADD·추격 금지.",
    "HST": "중상·고점 — 호텔. 업사이드 음수면 추격 비추.",
    "INDV": "중·청산후워치 — 기청산. 재진입은 새 셋업·비중 여유 시.",
    "TXG": "중하·품질C·보유4주·한도OVER·추가금지 — 19.3%>C6%·stop $42. NO_ADD·추격 금지.",
    "APA": "중·품질C·보유1주·추가금지 — 3.0%·stop $40. NO_ADD·추격 금지.",
    "ADPT": "중·SOFT·실적직후 — 소화 확인 후.",
    "SBLK": "중상·고점주의 — 건화물. 위성·눌림만.",
    "CASY": "중·SOFT·고점주의 — 고가주. 추격보다 관망.",
    "AMRX": "중·청산후워치·추격금지 — 09-16 청산 완료. 재매수·추격 금지.",
    "ANAB": "상·품질C·보유4주·한도OVER·추가금지 — 14.0%>C6%·stop $48. NO_ADD·추격 금지.",
    "APPS": "중·품질C·보유20주·한도OVER·추가금지 — 14.9%>C6%·stop $10. NO_ADD·추격 금지.",
    ...
    "DRH": "중·품질C·보유14주(+1)·한도OVER·추가금지 — 11.1%>C6%·stop $11.94. NO_ADD.",
    ...
    "ATRO": "중·품질C·보유2주(+1)·stop하회·축소검토·추가금지 — 8.6%·마크<$68 stop. 축소검토·NO_ADD.",
    "AVT": "중 — IT 유통. 중간·눌림.",
    "ALNT": "중 — 모션컨트롤. 산업 베타.",
...
def load_buy_scenarios() -> list[dict]:
    p = Path("/workspace/reports/buy_scenarios_20260916.json")
    if not p.exists():
        return []
...
def main() -> None:
    ...
    <section class="cover">
      ...
      <div class="portfolio-box" style="text-align:left;max-width:560px;margin:16px auto;">
        ...
        보유: TXG4 · ECPG3 · APPS20 · ANAB4 · DRH14 · ROKU1 · ATRO2 · APA1 · 평가~$1,557 · 현금합≈$255<br/>
        AMRX 청산 · ROKU·APA 신규 · ECPG/DRH/ATRO 증액 · Top3≈53.2% · 8종 전원 NO_ADD · 전개가능≈$105<br/>
        유니버스∩보유: TXG·ECPG·ROKU·APA (ANAB·APPS·DRH·ATRO는 유니버스 외·NO_ADD 유지)<br/>
    ...
    <p class="small">정렬: Chase RR. 가격·PT는 {DATE_TAG} 라이브. 45종 · 유니버스: MU·NBIS·FIVE·OMDA·CORT·BLFS·KSPI·ZLAB 등 · ATRO 보유1주 NO_ADD.<br/>
    ...
    <section class="ticker-section">
      ...
      <p class="small">다음 단계: 기술적분석() ← chase_rr_20260916.json</p>
    </section>
    </body></html>
    """
