#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fetch Chase rank + qual stubs for 2026-08-18 deep universe (54 tickers)."""
...
ASOF = date(2026, 8, 18)
TICKERS = [
    "MU", "BLZE", "ETON", "APPS", "CDNA", "FSLY", "CLMT", "LIND", "FORM", "CRSR",
    "COHU", "TH", "FTNT", "VCTR", "KALU", "RELY", "ROKU", "ICUI", "MRCY", "SBLK",
    "ATRO", "TER", "NESR", "IESC", "IART", "STLD", "STX", "FA", "PLPC", "ECPG",
    "DIOD", "DXCM", "VSEC", "SITM", "AEHR", "SYRE", "CBRL", "NEOG", "AVT", "ENTG",
    "ALNT", "TSEM", "FROG", "CRDO", "NSIT", "NTRA", "AMRX", "DGII", "CAKE", "DDOG",
    "CHEF", "BELFB", "BELFA", "ADEA",
]
OUT = Path("/workspace/reports/rank_20260818.json")
QUAL_SEEDS = [
...
QUAL_OUT = Path("/workspace/reports/qual_20260818.json")
FORMULA = (
