#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fetch Chase rank + qual stubs for 2026-08-14 deep universe (52 tickers)."""
...
ASOF = date(2026, 8, 14)
TICKERS = [
    "BLZE", "APPS", "CDNA", "FSLY", "LIND", "CLMT", "FORM", "CRSR", "COHU", "FTNT",
    "VCTR", "FTRE", "KALU", "ROKU", "RELY", "ICUI", "TILE", "SHOO", "MRCY", "NVCR",
    "ATRO", "TER", "NESR", "IESC", "IART", "STLD", "STX", "FA", "PLPC", "ECPG",
    "SAIC", "DXCM", "SITM", "AEHR", "SYRE", "CBRL", "NEOG", "AVT", "ENTG", "ALNT",
    "TSEM", "FROG", "CRDO", "NSIT", "NTRA", "AMRX", "DGII", "CAKE", "DDOG", "CHEF",
    "BELFB", "LITE",
]
OUT = Path("/workspace/reports/rank_20260814.json")
QUAL_SEEDS = [
...
QUAL_OUT = Path("/workspace/reports/qual_20260814.json")
FORMULA = (
...
def main():
    ...
    assert len(TICKERS) == 52, len(TICKERS)
    base = load_qual_base()
