#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fetch Chase rank + qual stubs for 2026-08-19 deep universe (46 tickers)."""
...
ASOF = date(2026, 8, 19)
TICKERS = [
    "BLZE", "ETON", "APPS", "CDNA", "CLMT", "FSLY", "COHU", "LIND", "FORM", "CRSR",
    "FTNT", "VCTR", "RELY", "ROKU", "ICUI", "SBLK", "TILE", "GPRE", "ATRO", "TER",
    "NESR", "IESC", "STLD", "STX", "FA", "PLPC", "ECPG", "SAIC", "VSEC", "SITM",
    "AEHR", "SYRE", "CBRL", "NEOG", "AVT", "ENTG", "ALNT", "FROG", "CRDO", "NSIT",
    "NTRA", "AMRX", "DGII", "CAKE", "CHEF", "LITE",
]
OUT = Path("/workspace/reports/rank_20260819.json")
QUAL_SEEDS = [
...
QUAL_OUT = Path("/workspace/reports/qual_20260819.json")
FORMULA = (
