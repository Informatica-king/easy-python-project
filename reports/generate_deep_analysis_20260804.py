#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""NASDAQ 심층분석 PDF — 2026-08-04 (50종목 · 매수시나리오 A′ 점검) + Chase 스냅샷 + 기술적분석 훅."""
...
RANK_PATH = Path("/workspace/reports/rank_20260804.json")
QUAL_PATH = Path("/workspace/reports/qual_20260804.json")

HTML_OUT = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-08-04.html")
PDF_WORKSPACE = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-08-04.pdf")
PDF_ARTIFACT = Path("/opt/cursor/artifacts/NASDAQ_Deep_Analysis_2026-08-04.pdf")
PDF_ASSETS = Path("/workspace/assets/NASDAQ_Deep_Analysis_2026-08-04.pdf")
CHASE_OUT = Path("/workspace/reports/chase_rr_20260804.json")
...
CHASE_DETAIL = {
    ...
    "FTNT": "중·A′후보 — 보안. A′ 통과(MA20근처·RSI60·고점−5%). 업사이드 음수면 사이즈 축소.",
    "CMPR": "중·A′후보 — 인쇄/커머스. A′ 통과(MA20·RSI52·고점−7%). 위성·소액만.",
    ...
    "NESR": "중상·보유위성·SOFT·추가금지 — 위성 한도. 홀드/축소 관찰.",
    "ALKS": "중상·SOFT·워치 — RR 2위·A′ 근접(스윙L). 실적 멀다·눌림·비중 여유 시.",
    "ECPG": "최상·코어·추가금지 — RR·Beat 상위·08-05 EARN_D5. 코어 과비중·추가금지.",
    ...
    "TXG": "하·과열·보유3주·추가금지 — 위성OVER·평단↓·08-06 EARN_D5. 물타기·추격 금지.",
    ...
    "AMRX": "중·보유·추가금지 — 코어 보유. 즉흥·추가 매수 금지.",
    "LASR": "중상·보유·이관1·추가금지 — 08-06 EARN_D5. 추격·추가 금지.",
    "RELY": "중·보유위성·추가금지 — 08-05 EARN_D5. 홀드·갭추격 금지.",
...
def load_buy_scenarios() -> list[dict]:
    p = Path("/workspace/reports/buy_scenarios_20260804.json")
    if not p.exists():
        return []
...
def main() -> None:
    ...
    <section class="cover">
      <h1>NASDAQ 심층분석</h1>
      <p class="sub">Chase Risk-Reward · 매수시나리오 A/B 점검 · 50종목 · A′ 게이트</p>
      ...
      <div class="portfolio-box" style="text-align:left;max-width:560px;margin:16px auto;">
        <b>포트 실행 메모 (8/4)</b><br/>
        보유: ECPG2 · AMRX9 · LASR2 · TXG3 · NESR4 · CMPR1 · RELY3 · 현금 $566 · SCHD 청산<br/>
        코어: ECPG+AMRX — ≤20% · 전원 NO_ADD · ECPG/RELY 08-05 · LASR/TXG 08-06 EARN_D5<br/>
        위성OVER: TXG~15% · NESR~12% · CMPR~11% — 추가·물타기 금지<br/>
        유니버스 EARN_D5: 08-04~08-07 (HUT/TVTX/COGT/BRKR · CGNX/ECPG/RELY/SBLK/EXEL · LASR/TXG/ROKU/RAPP 등)<br/>
        A′/SOFT는 0장 표 기준 · 실행은 포폴() 3레이어·위성한도 후
      </div>
    </section>
    {buy_scenario_section(scenarios)}
    <h2>Surprise / Chase 요약</h2>
    <p class="small">정렬: Chase RR. 가격·PT는 {DATE_TAG} 라이브. 50종 · 신규/교체: HUT·LASR·RELY·IART·CLBK·EXEL·TILE·CAKE·COGT·AXGN 등.<br/>
    ...
    <section class="ticker-section">
      ...
      <p class="small">다음 단계: 기술적분석() ← chase_rr_20260804.json</p>
    </section>
    </body></html>
    """
