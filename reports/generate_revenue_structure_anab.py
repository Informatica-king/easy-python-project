...
<p class="small">생성: 수익구조분석() · 티커 ANAB · 기준 {ASOF} · WeasyPrint + NanumGothic · sepa.rev_price_chart</p>
</body></html>
"""
...
def main() -> None:
    ...
    print(f"ANAB rev px={PX} pt={PT} upside={UPSIDE*100:.1f}% near_hi={NEAR_HI*100:.0f}%")
