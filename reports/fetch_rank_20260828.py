#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fetch Chase rank + qual stubs for 2026-08-28 deep universe (51 tickers)."""
...
ASOF = date(2026, 8, 28)
TICKERS = [
    "ETON", "CDNA", "TH", "CLMT", "FTNT", "LIND", "VCTR", "RELY", "CRSR", "ROKU",
    "ZBRA", "SBLK", "SLDE", "ATRO", "NESR", "INCY", "FA", "PLPC", "ECPG", "CBRL",
    "NEOG", "AVT", "ALNT", "FROG", "NSIT", "CRDO", "NTRA", "AMGN", "AMRX", "DGII",
    "CAKE", "CHEF", "SCSC", "GCT", "LITE", "TXG", "PLSE", "PRAX", "DNTH", "OMER",
    "AXGN", "LFST", "SEPN", "PRCH", "MGTX", "ZD", "HALO", "APA", "CLBK", "SRRK",
    "BRKR",
]

OUT = Path("/workspace/reports/rank_20260828.json")
QUAL_SEEDS = [
...
QUAL_OUT = Path("/workspace/reports/qual_20260828.json")
FORMULA = (
