#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fetch Chase rank + qual stubs for 2026-08-06 deep universe (55 tickers)."""
...
ASOF = date(2026, 8, 6)
TICKERS = [
    "APPS", "TXG", "CDNA", "LIND", "TVTX", "LASR", "FTNT", "FTRE", "FROG", "AMRX",
    "KALU", "FA", "CGNX", "SHOO", "AEIS", "ROKU", "RELY", "GPRE", "TER", "CRSR",
    "FLYW", "VTRS", "IESC", "STLD", "PLPC", "ECPG", "CLBK", "EXEL", "NESR", "AEHR",
    "CBRL", "NEOG", "SENEA", "PEBO", "ENTG", "DDOG", "CNXN", "CAKE", "PGNY", "CHEF",
    "BELFB", "ADEA", "SCSC", "LQDA", "DNTH", "SEPN", "COGT", "ATLC", "AXGN", "PTGX",
    "CLMT", "RAPP", "ALKS", "DRH", "TFSL",
]
OUT = Path("/workspace/reports/rank_20260806.json")
QUAL_SEEDS = [
...
QUAL_OUT = Path("/workspace/reports/qual_20260806.json")
FORMULA = (
...
def main():
    ...
    assert len(TICKERS) == 55, len(TICKERS)
    base = load_qual_base()
