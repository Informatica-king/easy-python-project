#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""NASDAQ 심층분석 PDF — 2026-09-24 (45종목 · 매수시나리오 A′ 점검) + Chase 스냅샷 + 기술적분석 훅."""
...
RANK_PATH = Path("/workspace/reports/rank_20260924.json")
QUAL_PATH = Path("/workspace/reports/qual_20260924.json")

HTML_OUT = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-09-24.html")
PDF_WORKSPACE = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-09-24.pdf")
PDF_ARTIFACT = Path("/opt/cursor/artifacts/NASDAQ_Deep_Analysis_2026-09-24.pdf")
PDF_ASSETS = Path("/workspace/assets/NASDAQ_Deep_Analysis_2026-09-24.pdf")
CHASE_OUT = Path("/workspace/reports/chase_rr_20260924.json")
...
# Portfolio-aware Chase label overrides — 2026-09-23
LABEL_OVERRIDE = {
    "ALKS": "중상·SOFT·워치",
    "ECPG": "중·보유3주·천장20%여유·추가금지",
    "ROKU": "중·보유1주·천장20%여유·추가금지",
    "HST": "중상·08-05·고점",
    "INDV": "중·청산후워치·08-04",
    "TXG": "중하·보유4주·유동17%·추가금지",
    "APA": "중·보유3주·천장20%여유·추가금지",
    "ADPT": "중·SOFT·실적직후",
    "SBLK": "중상·고점주의",
    "CASY": "중·SOFT·고점주의",
    "AMRX": "중·청산후워치·추격금지",
    "ANAB": "상·보유4주·천장20%여유·추가금지",
...
CHASE_DETAIL = {
    ...
    "ECPG": "중·보유3주(+1)·천장20%여유·추가금지 — 18.5%<20%·stop $80. NO_ADD·추격 금지.",
    "ROKU": "중·보유1주·천장20%여유·추가금지 — 9.6%<20%·stop $140. NO_ADD·추격 금지.",
    "HST": "중상·고점 — 호텔. 업사이드 음수면 추격 비추.",
    "INDV": "중·청산후워치 — 기청산. 재진입은 새 셋업·비중 여유 시.",
    "TXG": "중하·보유4주·유동17.3%·추가금지 — 유동천장20% 여유·stop $42. NO_ADD·추격 금지.",
    "APA": "중·보유3주(+2)·천장20%여유·추가금지 — 8.2%<20%·stop $40. NO_ADD·추격 금지.",
    "ADPT": "중·SOFT·실적직후 — 소화 확인 후.",
    "SBLK": "중상·고점주의 — 건화물. 위성·눌림만.",
    "CASY": "중·SOFT·고점주의 — 고가주. 추격보다 관망.",
    "AMRX": "중·청산후워치·추격금지 — 09-22 청산 완료. 재매수·추격 금지.",
    "ANAB": "상·보유4주·천장20%여유·추가금지 — 13.7%<20%·stop $48. NO_ADD·추격 금지.",
    ...
    "ATRO": "중·보유1주(−1)·stop경계·추가금지 — 4.3%<20%·마크≈stop $68. 축소완료·NO_ADD.",
    "AVT": "중 — IT 유통. 중간·눌림.",
    "ALNT": "중 — 모션컨트롤. 산업 베타.",
...
def load_buy_scenarios() -> list[dict]:
    p = Path("/workspace/reports/buy_scenarios_20260924.json")
    if not p.exists():
        return []
...
def main() -> None:
    ...
    HOLD_NO_ADD = {"TXG", "ECPG", "APPS", "ANAB", "ROKU", "ATRO", "APA"}
    for h in exec_hits:
    ...
    <section class="cover">
      ...
      <div class="portfolio-box" style="text-align:left;max-width:560px;margin:16px auto;">
        <b>포트 실행 메모 (9/24 스냅 · 최신 SSOT · 유동천장)</b><br/>
        <b>종목천장 20%</b>(유동=주식+현금 · A/B/C 폐기) · 금지=ADD0 · Top3≤50%(유동) · 현금바닥 $150<br/>
        보유: TXG4 · ECPG3 · APPS20 · ROKU1 · ANAB3 · APA3 · ATRO1 · 평가~$1,316 · 현금합≈$456<br/>
        DRH 14주 전량청산 · Top3≈45.8%(유동)≤50% · 7종 전원 NO_ADD · 전개가능≈$306<br/>
        유동비중: TXG 16.8% · ECPG 15.9% · APPS 13.0% · ROKU 8.6% · ANAB 8.6% · APA 7.4% · ATRO 3.9% · 전원&lt;20%<br/>
        유니버스∩보유: ROKU (TXG·ECPG·APPS·ANAB·APA·ATRO는 유니버스 외·NO_ADD 유지)<br/>
        DRH/AMRX/FTNT/SCSC/CMPR/NESR 청산후 추격금지 · ATRO stop $68 근처 · 실행창 17:30~20:55 지정가<br/>
        유니버스 45종 · +FSLY·SANM · −APPS·ENTG·CHEF·BAND·SCSC · 본선∩GO 강조 · PDF=GitHub Release만
      </div>
    </section>
    {buy_scenario_section(scenarios, exec_hits=exec_live)}
    <h2>Surprise / Chase 요약</h2>
    <p class="small">정렬: Chase RR. 가격·PT는 {DATE_TAG} 라이브. 45종 · 유니버스: MU·QMCO·CDNA·ETON·INTC·CLMT·FSLY·SANM·ROKU 등 · APA3·ATRO1·ANAB3 NO_ADD.<br/>
    ...
    <section class="ticker-section">
      ...
      <p class="small">다음 단계: 기술적분석() ← chase_rr_20260924.json</p>
    </section>
    </body></html>
    """
    ...
    try:
        ...
        notes = (
            ...
            f"- 보유 NO_ADD: TXG·ECPG·APPS·ANAB·ROKU·ATRO·APA (DRH 09-24 청산)\n"
            f"- 비중정책: 종목천장 20%(유동=주식+현금) · Top3≤50% · TXG≈16.8%(유동) · Top3≈45.8%(유동)≤50%\n"
        )
