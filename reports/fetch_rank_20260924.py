#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fetch Chase rank + qual stubs for 2026-09-24 deep universe (45 tickers)."""
...
ASOF = date(2026, 9, 24)
TICKERS = [
    "MU", "QMCO", "CDNA", "ETON", "INTC", "CLMT", "FSLY", "TH", "COHU", "FTNT",
    "CRSR", "FEIM", "NBIS", "RDVT", "ZBRA", "SBLK", "ROKU", "SLDE", "TER", "IOVA",
    "NESR", "INCY", "SNDK", "XNCR", "HTFL", "STX", "PLPC", "SIMO", "DXCM", "SANM",
    "NTNX", "CORT", "MRVL", "QRVO", "NEOG", "AVT", "ALNT", "FROG", "NSIT", "NTRA",
    "CNXN", "AMRX", "DGII", "CAKE", "DDOG",
]

OUT = Path("/workspace/reports/rank_20260924.json")
QUAL_SEEDS = [
...
QUAL_OUT = Path("/workspace/reports/qual_20260924.json")
FORMULA = (
