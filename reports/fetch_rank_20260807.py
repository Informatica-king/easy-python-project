#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fetch Chase rank + qual stubs for 2026-08-07 deep universe (53 tickers)."""
...
ASOF = date(2026, 8, 7)
TICKERS = [
    "APPS", "CDNA", "TXG", "LIND", "FA", "FTNT", "LGND", "FTRE", "AMRX", "RELY",
    "MRCY", "ROKU", "SHOO", "AEIS", "SBLK", "TER", "CRSR", "IESC", "STLD", "PLPC",
    "ECPG", "CLBK", "SITM", "NESR", "SYRE", "AEHR", "CBRL", "NEOG", "AVT", "PEBO",
    "CNXN", "DGII", "CAKE", "CHEF", "NSIT", "BELFB", "SCSC", "VSAT", "BLMN", "ALNT",
    "LQDA", "DNTH", "PLSE", "SEPN", "COGT", "LFST", "CLMT", "AXGN", "VCTR", "DRH",
    "ZD", "SRRK", "MNST",
]
OUT = Path("/workspace/reports/rank_20260807.json")
QUAL_SEEDS = [
    ...
    Path("/workspace/reports/qual_20260801.json"),
    Path("/workspace/reports/qual_20260731.json"),
]
QUAL_OUT = Path("/workspace/reports/qual_20260807.json")
FORMULA = (
...
def main():
    ...
    assert len(TICKERS) == 53, len(TICKERS)
    base = load_qual_base()
