#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fetch Chase rank + qual stubs for 2026-09-16 deep universe (45 tickers)."""
...
OUT = Path("/workspace/reports/rank_20260916.json")
QUAL_SEEDS = [
...
QUAL_OUT = Path("/workspace/reports/qual_20260916.json")
FORMULA = (
