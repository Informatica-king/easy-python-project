#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""NASDAQ 심층분석 PDF — 2026-09-08 (50종목 · 매수시나리오 A′ 점검) + Chase 스냅샷 + 기술적분석 훅."""
...
RANK_PATH = Path("/workspace/reports/rank_20260908.json")
QUAL_PATH = Path("/workspace/reports/qual_20260908.json")

HTML_OUT = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-09-08.html")
PDF_WORKSPACE = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-09-08.pdf")
PDF_ARTIFACT = Path("/opt/cursor/artifacts/NASDAQ_Deep_Analysis_2026-09-08.pdf")
PDF_ASSETS = Path("/workspace/assets/NASDAQ_Deep_Analysis_2026-09-08.pdf")
CHASE_OUT = Path("/workspace/reports/chase_rr_20260908.json")
...
CHASE_DETAIL = {
    ...
    "ATRO": "중·품질C·보유1주·추가금지 — 5.7%·stop $68. NO_ADD·추격 금지.",
    "INCY": "중·SOFT — 업사이드 작으면 대기.",
    "AVT": "중 — IT 유통. 중간·눌림.",
    "ALNT": "중 — 모션컨트롤. 산업 베타.",
    "BRKR": "중하 — 분석기기. 대기.",
...
def load_buy_scenarios() -> list[dict]:
    p = Path("/workspace/reports/buy_scenarios_20260908.json")
    if not p.exists():
        return []
...
def main() -> None:
    ...
    <section class="cover">
      <h1>NASDAQ 심층분석</h1>
      <p class="sub">Chase 본선 · 타이밍 GO · 확정 EARN_D5 · 50종 · 군인 프리마켓 실행</p>
    ...
    <p class="small">정렬: Chase RR. 가격·PT는 {DATE_TAG} 라이브. 50종 · 신규/복귀: MU·NBIS·FIVE·OMDA·CORT·BLFS·KSPI·ZLAB 등 · ATRO 보유1주 NO_ADD.<br/>
    ...
    <section class="ticker-section">
      ...
      <p class="small">다음 단계: 기술적분석() ← chase_rr_20260908.json</p>
    </section>
    </body></html>
    """
    ...
    try:
        ...
        notes = (
            f"## NASDAQ 심층분석 ({DATE_TAG}) · {len(order)}종 · 50-ticker universe\n\n"
