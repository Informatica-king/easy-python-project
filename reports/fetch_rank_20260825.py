#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fetch Chase rank + qual stubs for 2026-08-25 deep universe (45 tickers)."""
...
ASOF = date(2026, 8, 25)
TICKERS = [
    "ETON", "CDNA", "CLMT", "LIND", "TH", "VCTR", "ROKU", "RELY", "SBLK", "SLDE",
    "TILE", "NESR", "FA", "PLPC", "ECPG", "SYRE", "CBRL", "NEOG", "FROG", "NSIT",
    "NTRA", "AMGN", "AMRX", "DGII", "CAKE", "CHEF", "SCSC", "LITE", "TXG", "PRAX",
    "PLSE", "DNTH", "ANAB", "SEPN", "LFST", "MGTX", "AXGN", "PRCH", "ZD", "HALO",
    "APA", "CLBK", "DRH", "SRRK", "KSPI",
]
OUT = Path("/workspace/reports/rank_20260825.json")
QUAL_SEEDS = [
...
QUAL_OUT = Path("/workspace/reports/qual_20260825.json")
FORMULA = (
