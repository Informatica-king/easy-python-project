#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""NASDAQ 심층분석 PDF — 2026-07-24 (44종목) + Chase 스냅샷 + 기술적분석 훅."""
...
RANK_PATH = Path("/tmp/rank_20260724.json")
QUAL_PATH = Path("/tmp/qual_20260724.json")

HTML_OUT = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-07-24.html")
PDF_WORKSPACE = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-07-24.pdf")
PDF_ARTIFACT = Path("/opt/cursor/artifacts/NASDAQ_Deep_Analysis_2026-07-24.pdf")
PDF_ASSETS = Path("/workspace/assets/NASDAQ_Deep_Analysis_2026-07-24.pdf")
CHASE_OUT = Path("/workspace/reports/chase_rr_20260724.json")
...
# Portfolio-aware Chase label overrides — 2026-07-24
LABEL_OVERRIDE = {
    "SLS": "상·위성·바이너리",
    "LASR": "상·08-06",
    "ECPG": "최상·코어보유·추가금지",
...
def main() -> None:
    ...
    <section class="cover">
      <h1>NASDAQ 심층분석</h1>
      <p class="sub">Chase Risk-Reward · 실적 서프라이즈 · 44종목</p>
      ...
      <div class="portfolio-box" style="text-align:left;max-width:520px;margin:24px auto;">
        <b>포트 실행 메모 (7/24)</b><br/>
        보유: NEO · ECPG · AMRX · MU · ASTH · NESR · INDV<br/>
        이벤트: NEO/ALKS/ACHC/STX/KNSA 07-28 · AMRX/VCYT 07-30<br/>
        신규 관심: TSEM · CRDO · AMAT (반도체 축)<br/>
        NESR: $25–27 밴드만 · 보유분 추가금지 유지<br/>
        SLS 바이너리·과열군 추격 금지 · 버퍼 현금 유지
      </div>
    </section>
