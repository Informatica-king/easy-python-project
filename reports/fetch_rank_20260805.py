#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fetch Chase rank + qual stubs for 2026-08-05 deep universe (60 tickers)."""
...
ASOF = date(2026, 8, 5)
TICKERS = [
    "TXG", "CDNA", "LIND", "LASR", "TVTX", "FTNT", "FTRE", "FROG", "AMRX", "VISN",
    "CGNX", "KALU", "MRCY", "FA", "SHOO", "AEIS", "GPRE", "ROKU", "RELY", "TER",
    "CRSR", "XMTR", "VTRS", "IESC", "IART", "STLD", "PLPC", "ECPG", "ENTG", "CLBK",
    "ANDE", "ENLT", "NESR", "AEHR", "CBRL", "NEOG", "SENEA", "PEBO", "DDOG", "CRDO",
    "CNXN", "CAKE", "PGNY", "CHEF", "BELFB", "ADEA", "SCSC", "LQDA", "DNTH", "NBIS",
    "COGT", "SEPN", "ATLC", "AXGN", "CLMT", "PTGX", "RAPP", "ALKS", "DRH", "TFSL",
]
OUT = Path("/workspace/reports/rank_20260805.json")
QUAL_SEEDS = [
...
QUAL_OUT = Path("/workspace/reports/qual_20260805.json")
FORMULA = (
