#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""NASDAQ 심층분석 PDF — 2026-08-01 (51종목 · 매수시나리오 A′ 점검) + Chase 스냅샷 + 기술적분석 훅."""
...
RANK_PATH = Path("/workspace/reports/rank_20260801.json")
QUAL_PATH = Path("/workspace/reports/qual_20260801.json")

HTML_OUT = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-08-01.html")
PDF_WORKSPACE = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-08-01.pdf")
PDF_ARTIFACT = Path("/opt/cursor/artifacts/NASDAQ_Deep_Analysis_2026-08-01.pdf")
PDF_ASSETS = Path("/workspace/assets/NASDAQ_Deep_Analysis_2026-08-01.pdf")
CHASE_OUT = Path("/workspace/reports/chase_rr_20260801.json")
...
CHASE_DETAIL = {
    ...
    "NESR": "중상·보유위성·SOFT — 포트 3주. A′ 근접·추가보다 홀드/축소 관찰.",
    ...
    "TXG": "하·과열 — PT 프리미엄·고점권·08-06. RR와 무관 추격 비추천.",
    ...
    "JAZZ": "중·08-03·고점 — 제약·EARN_D5. 고점권 관망.",
...
def load_buy_scenarios() -> list[dict]:
    p = Path("/workspace/reports/buy_scenarios_20260801.json")
    if not p.exists():
        return []
...
def main() -> None:
    ...
    <section class="cover">
      <h1>NASDAQ 심층분석</h1>
      <p class="sub">Chase Risk-Reward · 매수시나리오 A/B 점검 · 51종목 · A′ 게이트</p>
      ...
      <div class="portfolio-box" style="text-align:left;max-width:560px;margin:16px auto;">
        <b>포트 실행 메모 (8/1)</b><br/>
        보유: ECPG2 · AMRX9 · LASR2 · SCHD3 · NESR3 · RELY3 · 현금 여유(~52%)<br/>
        코어: ECPG(금융)+AMRX(헬스케어) — 각 ≤20% · 추가금지(ECPG는 08-05 EARN_D5)<br/>
        보유 실적창: ECPG 08-05 · RELY(유니버스外) · NESR 08-18<br/>
        유니버스 EARN_D5 다수: 08-03~08-07 (TXG/ROKU/RAPP/APA/HST/SBLK/CGNX 등)<br/>
        A′고지: <b>LAUR · FTNT · CMPR</b> · B=0 · SOFT: ALKS·NESR·CASY·ADPT·INCY·TFSL·SEPN
      </div>
    </section>
    ...
    <section class="ticker-section">
      ...
      <p class="small">다음 단계: 기술적분석() ← chase_rr_20260801.json</p>
    </section>
    </body></html>
    """
