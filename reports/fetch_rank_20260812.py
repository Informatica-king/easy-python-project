#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fetch Chase rank + qual stubs for 2026-08-12 deep universe (60 tickers)."""
...
ASOF = date(2026, 8, 12)
TICKERS = [
    "BLZE", "APPS", "CDNA", "FSLY", "LIND", "CLMT", "CRSR", "FTNT", "FTRE", "KALU",
    "VCTR", "ROKU", "MRCY", "ICUI", "SHOO", "NVCR", "RELY", "TILE", "NESR", "IESC",
    "STLD", "FA", "PLPC", "ECPG", "DIOD", "DXCM", "AEHR", "SYRE", "CBRL", "NEOG",
    "AVT", "ENTG", "ALNT", "TSEM", "FROG", "CRDO", "NSIT", "NTRA", "AMRX", "DGII",
    "CAKE", "CHEF", "BELFB", "LITE", "VSAT", "ATEX", "TXG", "DNTH", "LQDA", "SEPN",
    "PLSE", "ANAB", "AXGN", "LFST", "APA", "HALO", "LGND", "ZD", "CLBK", "BCRX",
]
OUT = Path("/workspace/reports/rank_20260812.json")
QUAL_SEEDS = [
...
QUAL_OUT = Path("/workspace/reports/qual_20260812.json")
FORMULA = (
...
def main():
    ...
    assert len(TICKERS) == 60, len(TICKERS)
    base = load_qual_base()
