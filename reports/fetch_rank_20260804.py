#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fetch Chase rank + qual stubs for 2026-08-04 deep universe (50 tickers)."""
...
ASOF = date(2026, 8, 4)
TICKERS = [
    "CDNA", "TXG", "HUT", "LIND", "TVTX", "FTNT", "FTRE", "LASR", "AMRX", "JAZZ",
    "FA", "CGNX", "SHOO", "GPRE", "ROKU", "RELY", "CRSR", "SBLK", "VTRS", "IESC",
    "IART", "CASY", "STLD", "ECPG", "CLBK", "EXEL", "NESR", "CBRL", "SENEA", "TILE",
    "PEBO", "DDOG", "CNXN", "CAKE", "PGNY", "CHEF", "SCSC", "LQDA", "DNTH", "CLMT",
    "COGT", "AXGN", "ATLC", "SEPN", "PTGX", "BRKR", "RAPP", "ALKS", "DRH", "TFSL",
]
OUT = Path("/workspace/reports/rank_20260804.json")
QUAL_SEEDS = [
...
QUAL_OUT = Path("/workspace/reports/qual_20260804.json")
FORMULA = (
...
def main():
    ...
    assert len(TICKERS) == 50, len(TICKERS)
    base = load_qual_base()
