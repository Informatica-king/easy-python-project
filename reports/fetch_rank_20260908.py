#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fetch Chase rank + qual stubs for 2026-09-08 deep universe (50 tickers)."""
...
ASOF = date(2026, 9, 8)
TICKERS = [
    "MU", "ETON", "CDNA", "CLMT", "NBIS", "TH", "CRSR", "VCTR", "RELY", "SLDE",
    "SBLK", "ROKU", "ZBRA", "FIVE", "OMDA", "ATRO", "NESR", "INCY", "FA", "PLPC",
    "ECPG", "CORT", "NEOG", "AVT", "ALNT", "NSIT", "NTRA", "AMGN", "CAKE", "CHEF",
    "SCSC", "GCT", "LITE", "TXG", "PLSE", "PRAX", "OMER", "DNTH", "LFST", "PRCH",
    "AXGN", "MGTX", "HALO", "CLBK", "APA", "BLFS", "KSPI", "ZD", "ZLAB", "SRRK",
]

OUT = Path("/workspace/reports/rank_20260908.json")
QUAL_SEEDS = [
...
QUAL_OUT = Path("/workspace/reports/qual_20260908.json")
FORMULA = (
