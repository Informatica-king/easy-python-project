#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""NASDAQ 심층분석 PDF — 2026-09-25 (45종목 · 매수시나리오 A′ 점검) + Chase 스냅샷 + 기술적분석 훅."""
...
RANK_PATH = Path("/workspace/reports/rank_20260925.json")
QUAL_PATH = Path("/workspace/reports/qual_20260925.json")

HTML_OUT = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-09-25.html")
PDF_WORKSPACE = Path("/workspace/reports/NASDAQ_Deep_Analysis_2026-09-25.pdf")
PDF_ARTIFACT = Path("/opt/cursor/artifacts/NASDAQ_Deep_Analysis_2026-09-25.pdf")
PDF_ASSETS = Path("/workspace/assets/NASDAQ_Deep_Analysis_2026-09-25.pdf")
CHASE_OUT = Path("/workspace/reports/chase_rr_20260925.json")
...
NEW_Q = {
    ...
    "NBIS": {
        ...
        "sector": "IT·AI인프라",
        "feat": "AI 클라우드·GPU",
        "item": "AI 인프라. 한줄: GPU 클라우드·AI 컴퓨팅 플랫폼",
        "fin": "성장·캡ex · 적자 가능",
        "strat": "고변동 AI · 위성 극소 · 추격 주의",
        "news": "GPU 공급·수주·현금",
        "bull": "—", "base": "—", "bear": "—",
        "brk": "수요 둔화·희석", "eps": "—", "entry": "관망",
        "drop": "가이던스 컷·희석", "chase": "중·고변동", "abc": "—",
    },
    "FIVE": {
        "name": "Five Below",
        "sector": "소비·할인소매",
        "feat": "가치 소매·티너",
        "item": "할인소매. 한줄: $5 중심 가치 소매 체인",
        "fin": "동일점·트래픽",
        "strat": "소비 베타 · 눌림·위성",
        "news": "동일점판매·가이던스",
        "bull": "—", "base": "—", "bear": "—",
        "brk": "소비 둔화", "eps": "—", "entry": "관망",
        "drop": "가이던스 컷", "chase": "중", "abc": "—",
    },
    "OMDA": {
        "name": "OMDA",
        "sector": "—",
        "feat": "—",
        "item": "OMDA. 한줄: 신규 유니버스 — 최신 10-Q/8-K 확인",
        "fin": "라이브 stub",
        "strat": "중 · 신규 포함 · 추격 주의",
        "news": "실적·가이던스",
        "bull": "—", "base": "—", "bear": "—",
    ...
    "CORT": {
        ...
        "sector": "헬스케어·내분비",
        "feat": "코르티솔 조절 치료",
        "item": "바이오. 한줄: Cushing·대사 질환 코르티솔 조절제",
        "fin": "Korlym·파이프라인",
        "strat": "바이오 위성 · 변동성",
        "news": "승인·매출·임상",
        "bull": "—", "base": "—", "bear": "—",
        "brk": "임상/승인 실패", "eps": "—", "entry": "관망",
        "drop": "가이던스 컷", "chase": "중", "abc": "—",
    },
    "BLFS": {
        ...
        "sector": "헬스케어·바이오툴",
        "feat": "세포보존·콜드체인",
        "item": "바이오툴. 한줄: 세포·유전자치료 보존 미디어·장비",
        "fin": "수주·마진",
        "strat": "위성 · 눌림",
        "news": "세포치료 수요·가이던스",
        "bull": "—", "base": "—", "bear": "—",
        "brk": "수요 둔화", "eps": "—", "entry": "관망",
        "drop": "가이던스 컷", "chase": "중", "abc": "—",
    },
    "KSPI": {
        "name": "Kaspi.kz",
        "sector": "금융·핀테크",
        "feat": "카자흐 슈퍼앱·결제",
        "item": "핀테크. 한줄: 결제·마켓플레이스·핀테크 슈퍼앱",
        "fin": "GMV·마진·규제",
        "strat": "이머징 핀테크 · 위성 · FX 리스크",
        "news": "GMV·규제·배당",
        "bull": "—", "base": "—", "bear": "—",
        "brk": "규제·FX 급변", "eps": "—", "entry": "관망",
        "drop": "가이던스 컷", "chase": "중", "abc": "—",
    },
    "ZLAB": {
        "name": "Zai Lab",
        "sector": "헬스케어·바이오",
        "feat": "중국 바이오파트너",
        "item": "바이오. 한줄: 중국 중심 혁신신약 라이선스·상업화",
        "fin": "파이프라인·상업화",
        "strat": "바이오 위성 · 지정학·규제 리스크",
        "news": "승인·매출·파트너십",
        "bull": "—", "base": "—", "bear": "—",
        "brk": "승인 실패·규제", "eps": "—", "entry": "관망",
        "drop": "파이프라인 실패", "chase": "중하", "abc": "—",
    },
    "LITE": {
        "name": "Lumentum",
        "sector": "IT·광통신",
    ...
    "ZBRA": {
        ...
        "sector": "IT·자동식별",
        "feat": "바코드·모바일컴퓨터·RFID",
        "item": "자동식별. 한줄: 엔터프라이즈 바코드·모바일·프린터",
        "fin": "산업캡ex·재고 사이클",
        "strat": "중 · 산업자동화 베타 · 눌림",
        "news": "수요·가이던스·마진",
        "bull": "$420–480",
    ...
    "GCT": {
        ...
        "sector": "소비·B2B커머스",
        "feat": "대형가구 B2B 마켓플레이스",
        "item": "B2B 커머스. 한줄: 대형 가구·홈상품 B2B 플랫폼",
        "fin": "소형·변동 · GMV·마진",
        "strat": "중하 · 위성 극소 · 추격 주의",
        "news": "GMV·수수료·재고",
        "bull": "$40–55",
    ...
    "OMER": {
        ...
        "sector": "헬스케어·바이오",
        "feat": "보체·염증 파이프라인",
        "item": "바이오. 한줄: 보체 경로·염증 치료제 임상",
        "fin": "임상 바이너리 · 자금 조달",
        "strat": "중하 · 위성 극소 · 임상 변동",
        "news": "임상·승인·현금활주로",
        "bull": "—",
        "base": "—",
        "bear": "—",
...
# Portfolio-aware Chase label overrides — 2026-09-25
LABEL_OVERRIDE = {
    "ALKS": "중상·SOFT·워치",
    "ECPG": "중·보유3주·유동16%·추가금지",
    "ROKU": "중·보유1주·유동8%·추가금지",
    "MU": "중·재진입0.095주·유동6%·추가금지",
    "HST": "중상·08-05·고점",
    "INDV": "중·청산후워치·08-04",
    "TXG": "중하·보유4주·유동18.5%·추가금지",
    "APA": "중·보유4주·천장20%여유·추가금지",
    "ADPT": "중·SOFT·실적직후",
    "SBLK": "중상·고점주의",
    "CASY": "중·SOFT·고점주의",
    "AMRX": "중·청산후워치·추격금지",
    "ANAB": "상·보유3주·천장20%여유·추가금지",
    "APPS": "중·보유20주·천장20%여유·추가금지",
    "LASR": "중상·청산후워치·추격금지",
...
CHASE_DETAIL = {
    ...
    "FTNT": "중·청산후워치·추격금지 — 09-08 청산 완료. 재매수·추격 금지.",
    ...
    "ECPG": "중·보유3주·유동16.1%·추가금지 — stop $80. NO_ADD·추격 금지.",
    "ROKU": "중·보유1주·유동8.4%·추가금지 — stop $140. NO_ADD·추격 금지.",
    "MU": "중·재진입 0.095주·유동5.7%·추가금지 — 실적 09-30. NO_ADD·갭추격 금지.",
    "HST": "중상·고점 — 호텔. 업사이드 음수면 추격 비추.",
    "INDV": "중·청산후워치 — 기청산. 재진입은 새 셋업·비중 여유 시.",
    "TXG": "중하·보유4주·유동18.5%·천장근접·추가금지 — stop $42. NO_ADD·추격 금지.",
    "APA": "중·보유4주(+1)·천장20%여유·추가금지 — 9.5%<20%·stop $40. NO_ADD·추격 금지.",
    "ADPT": "중·SOFT·실적직후 — 소화 확인 후.",
    "SBLK": "중상·고점주의 — 건화물. 위성·눌림만.",
    "CASY": "중·SOFT·고점주의 — 고가주. 추격보다 관망.",
    "AMRX": "중·청산후워치·추격금지 — 09-22 청산 완료. 재매수·추격 금지.",
    "ANAB": "상·보유3주·천장20%여유·추가금지 — 8.5%<20%·stop $48. NO_ADD·추격 금지.",
    "APPS": "중·보유20주·천장20%여유·추가금지 — 15.3%<20%·stop $10. NO_ADD·추격 금지.",
    ...
    "DRH": "중·보유14주(+1)·천장20%여유·추가금지 — 10.7%<20%·stop $11.94. NO_ADD.",
    ...
    "ZBRA": "중 — 자동식별. 산업캡ex·눌림 확인.",
    "GCT": "중하·소형변동 — B2B 가구 커머스. 위성 극소·추격 주의.",
    "OMER": "중하·임상변동 — 보체 바이오. 임상·자금 확인 전 추격 금지.",
    "CRDO": "중·청산후워치·추격금지 — 기청산. 재매수·추격 금지.",
    "ATRO": "중·보유2주(+1)·stop경계·추가금지 — 7.6%<20%·마크≈stop $68. NO_ADD.",
    "AVT": "중 — IT 유통. 중간·눌림.",
    "ALNT": "중 — 모션컨트롤. 산업 베타.",
    "RDVT": "중 — 데이터·분석. 눌림·비중 확인.",
    "XNCR": "중하·임상변동 — 바이오. 임상·파트너 확인 전 추격 금지.",
    "NTNX": "중·고점주의 — 하이브리드 클라우드. 고점·추격보다 눌림.",
    "QRVO": "중 — RF 반도체. 사이클·눌림.",
    "FROG": "중·고점주의 — DevOps. 고점권이면 관망.",
    "DBX": "중 — 클라우드 스토리지. 중간·눌림.",
    "OSBC": "중·지역은행 — 커뮤니티뱅크. 급등 추격 불필요.",
    "SAIC": "중 — 정부 IT. 수주·마진 확인.",
    "LITE": "중상·고점주의 — 광통신. AI 수요·고점권 주의.",
    "HALO": "중 — 약물전달. 위성·눌림.",
    "BLFS": "중 — 바이오툴. 위성·눌림.",
    "CORT": "중·바이오변동 — Cushing. 승인·매출 확인.",
    "ETON": "중하·소형 — 특수약. 위성 극소·변동성.",
    "PLSE": "중하·임상변동 — 바이오. 임상 확인 전 추격 금지.",
    "LFST": "중 — 행동건강. 눌림·비중.",
    "ZD": "중하 — 디지털 미디어. RR 약하면 관망.",
    "CLBK": "중·지역은행 — 커뮤니티뱅크. 급등 추격 불필요.",
    "NEOG": "중 — 식품안전. 중간·눌림.",
    "NSIT": "중 — IT 솔루션. 중간.",
    "NTRA": "중상 — 액체생검. 위성·변동 허용 시.",
    "PLPC": "중 — 전선·인프라. 중간.",
    "FIVE": "중 — 할인소매. 소비 베타·눌림.",
}
...
def load_buy_scenarios() -> list[dict]:
    p = Path("/workspace/reports/buy_scenarios_20260925.json")
    if not p.exists():
        return []
...
def main() -> None:
    ...
    HOLD_NO_ADD = {"TXG", "ECPG", "APPS", "ANAB", "ROKU", "ATRO", "APA", "MU"}
    for h in exec_hits:
    ...
    <section class="cover">
      ...
      <div class="portfolio-box" style="text-align:left;max-width:560px;margin:16px auto;">
        <b>포트 실행 메모 (9/25 스냅 · 최신 SSOT · 유동천장)</b><br/>
        <b>종목천장 20%</b>(유동=주식+현금 · A/B/C 폐기) · 금지=ADD0 · Top3≤50%(유동) · 현금바닥 $150<br/>
        보유: TXG4 · ECPG3 · APPS20 · APA4 · ANAB3 · ROKU1 · ATRO2 · MU 0.095 · 평가~$1,571 · 현금합≈$243<br/>
        APA+1 · ATRO+1 · MU 재진입 · Top3≈46.8%(유동)≤50% · 8종 전원 NO_ADD · 전개가능≈$93<br/>
        유동비중: TXG 18.5% · ECPG 16.1% · APPS 12.2% · APA 9.5% · ANAB 8.5% · ROKU 8.4% · ATRO 7.6% · MU 5.7%<br/>
        유니버스∩보유: ECPG · ROKU · MU (TXG·APPS·ANAB·APA·ATRO는 유니버스 외·NO_ADD 유지)<br/>
        DRH/AMRX/FTNT/SCSC/CMPR/NESR 청산후 추격금지 · ATRO stop $68 근처 · MU 실적 09-30 · 실행창 17:30~20:55 지정가<br/>
        유니버스 45종 · +ECPG·DIOD·ENTG · −SNDK·CAKE·DDOG · 본선∩GO 강조 · PDF=GitHub Release만
      </div>
    </section>
    {buy_scenario_section(scenarios, exec_hits=exec_live)}
    <h2>Surprise / Chase 요약</h2>
    <p class="small">정렬: Chase RR. 가격·PT는 {DATE_TAG} 라이브. 45종 · 유니버스: MU·ECPG·DIOD·ENTG·FSLY·ROKU 등 · APA4·ATRO2·MU NO_ADD.<br/>
    ...
    <section class="ticker-section">
      ...
      <p class="small">다음 단계: 기술적분석() ← chase_rr_20260925.json</p>
    </section>
    </body></html>
    """
    ...
    try:
        ...
        notes = (
            ...
            f"- 보유 NO_ADD: TXG·ECPG·APPS·ANAB·ROKU·ATRO·APA·MU (DRH 09-24 청산)\n"
            f"- 비중정책: 종목천장 20%(유동=주식+현금) · Top3≤50% · TXG≈18.5%(유동) · Top3≈46.8%(유동)≤50%\n"
        )
