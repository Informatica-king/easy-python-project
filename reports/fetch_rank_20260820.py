#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Fetch Chase rank + qual stubs for 2026-08-20 deep universe (53 tickers)."""
...
ASOF = date(2026, 8, 20)
TICKERS = [
    "ETON", "CDNA", "CLMT", "LIND", "CRSR", "FTRE", "VCTR", "ROKU", "RELY", "ICUI",
    "SBLK", "TILE", "NVCR", "GPRE", "ATRO", "NESR", "IESC", "FA", "PLPC", "ECPG",
    "SAIC", "SYRE", "CBRL", "NEOG", "ALNT", "FROG", "NSIT", "NTRA", "AMGN", "AMRX",
    "DGII", "CAKE", "CHEF", "LITE", "VSAT", "TXG", "PRAX", "DNTH", "PLSE", "SEPN",
    "ANAB", "LFST", "AXGN", "MGTX", "MRX", "ZD", "ALKS", "HALO", "APA", "CLBK",
    "BRKR", "SRRK", "DRH",
]
OUT = Path("/workspace/reports/rank_20260820.json")
QUAL_SEEDS = [
...
QUAL_OUT = Path("/workspace/reports/qual_20260820.json")
FORMULA = (
