...
PEER_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "SCSC": {
        "sector_ko": "IT 유통·채널 (심층: Specialty Tech + Intelisys)",
        "share_title": "상장 IT 유통·솔루션 피어셋 스케일 점유 (추정)",
        "share_as_of": "2026 · TTM 매출 스케일 근사 vs 전년",
        "share_note": (
            "상장 IT 유통·솔루션 피어셋 상대 스케일. "
            "SNX/ARW/AVT는 브로드라인 초대형이라 SCSC(스페셜티)와 절대 점유 비교 주의 — 방향·순위 감각용."
        ),
        "share_rows": [
            ("TD SYNNEX", 46.0, 45.0),
            ("Arrow", 24.0, 25.0),
            ...
            ("Insight", 6.0, 6.0),
            ("ScanSource", 3.5, 3.0),
            ("Others (listed)", 2.5, 2.0),
        ],
        "share_source": "Directional share of selected US-listed IT distribution/solutions peers by TTM revenue scale (est.)",
        "mix_buckets": ["Hardware Dist", "Solutions/VA", "Recurring/Agency"],
        "mix_as_of": "Q3 FY26 (ended Mar 31) net sales 성격 근사",
        "mix_rows": [
            {
                "key": "SCSC",
                "name": "SCSC",
                "subject": True,
                "yf": "SCSC",
                "mix": {"Hardware Dist": 90.0, "Solutions/VA": 4.5, "Recurring/Agency": 5.5},
                "note": "Q3: Products/services $726M · Recurring $41M · Specialty≈97% of sales",
            },
            {
                "key": "AVT",
                "name": "AVT",
                "subject": False,
                "yf": "AVT",
                "mix": {"Hardware Dist": 88.0, "Solutions/VA": 10.0, "Recurring/Agency": 2.0},
                "note": "브로드라인 부품·이산 유통 근사",
            },
            {
                "key": "ARW",
                "name": "ARW",
                "subject": False,
                "yf": "ARW",
                "mix": {"Hardware Dist": 86.0, "Solutions/VA": 12.0, "Recurring/Agency": 2.0},
                "note": "글로벌 부품·IT 유통 근사",
            },
            {
                "key": "NSIT",
                "name": "NSIT",
                "subject": False,
                "yf": "NSIT",
                "mix": {"Hardware Dist": 55.0, "Solutions/VA": 40.0, "Recurring/Agency": 5.0},
                "note": "솔루션·VA 비중 상대 높음",
            },
            {
                "key": "PLUS",
                "name": "PLUS",
                "subject": False,
                "yf": "PLUS",
                "mix": {"Hardware Dist": 50.0, "Solutions/VA": 45.0, "Recurring/Agency": 5.0},
                "note": "솔루션/통합 비중 높음",
            },
        ],
        "mix_note": (
            "버킷 Hardware Dist / Solutions·VA / Recurring·Agency로 정규화. "
            "SCSC는 매출 기준 Specialty 하드웨어가 압도적이지만, "
            "총이익 기준으로는 Recurring/Intelisys 기여(~GP의 1/3)가 훨씬 큼 — 마진 스토리와 매출 믹스는 별개."
        ),
    },
}
